...
ALLOWED_HOSTS = ['locallibrary-fewf.onrender.com', '127.0.0.1']
...
NEON_URL = 'postgres://enriquesaou:KTBJx5lF0XtH@ep-hidden-hat-115002.\
eu-central-1.aws.neon.tech/neondb'
...
# db_from_env = dj_database_url.config(default='postgres://alumnodb:\
#                                      alumnodb@localhost:5432/psi',
#                                      conn_max_age=500)
...
# Tests will not run with this option on
# STATICFILES_STORAGE = 'whitenoise.storage.\
# CompressedManifestStaticFilesStorage'

CSRF_TRUSTED_ORIGINS = ['https://locallibrary-fewf.onrender.com']
