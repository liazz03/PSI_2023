...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        # Give test_user2 permission to renew books.
        # We reused the permission for this use case.
        permission = Permission.objects.get(name='Set book as returned')
        test_user2.user_permissions.add(permission)
        test_user2.save()
    ...
    def test_redirects_to_detail_view_on_success(self):
        self.client.login(username='testuser2',
                          password='2HJ1vRV0Z&3iD')
        fields = {'first_name': 'Pepito', 'last_name': 'Grillo',
                  'date_of_birth': '01/01/2001', 'date_of_death': '12/12/2012'}
        response = self.client.post(reverse('author-create'), fields)
        self.assertEqual(response.status_code, 302)
