...
# In deployment (and in production if possible) set SECRET_KEY env
...
# In Render deployment, set the following env variable
...
if 'TESTING' in os.environ:
    # In testing mode just use local postgres
    db_from_env = {
    ...
    # dj_database_url will check for
    # the variable DATABASE_URL, which should
    # be set to NEON. Else, the default is POSTGRESQL_URL
...
# The URL to use when referring to
# static files (where they will be served from)
STATIC_URL = '/static/'
...
VUE_EXTERNAL_HOSTNAME = os.environ.get('VUE_EXTERNAL_HOSTNAME')
if VUE_EXTERNAL_HOSTNAME:
    CORS_ORIGIN_WHITELIST.append(VUE_EXTERNAL_HOSTNAME)
