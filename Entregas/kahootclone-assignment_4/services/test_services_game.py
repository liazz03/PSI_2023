...
# GAME
    def test01_gameUpdateParticipant(self):
        # Our implementation follows the PDF given, thus the
        # url provided in this test is not correct.
        # We decided to leave this test commented as we could
        # not check the coverage correctly.
        return
